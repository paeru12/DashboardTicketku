...
export default function EventAdminScanStaff() {
  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-4">
        <h2 className="text-lg font-semibold">Scan Staff</h2>
              ...
              {pageData.length === 0 ? (
                ...
                pageData.map((row) => (
                  <tr key={row.id} className="hover:bg-slate-50 transition-colors">
                    ...
                    <td className="px-3 py-3">{row.assignedAt}</td>
                  </tr>
                ))
              )}
            </tbody>
      ...
      <Dialog open={open} onOpenChange={setOpen}>
        <DialogContent>
          ...
          <form onSubmit={handleAdd} className="space-y-4">
            <div>
              <label className="block text-sm mb-1">Nama Staff</label>
            ...
            <div>
              <label className="block text-sm mb-1">Gate</label>

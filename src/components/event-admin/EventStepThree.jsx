...
export default function EventStepThree({
  ...
  const resolvedActiveTicketId =
    activeTicketId || localActiveId || tickets[0]?.id;
  ...
  return (
    <div ref={topRef} className="space-y-6">
      <h2 className="text-lg font-semibold">
        {readOnly ? "Detail Ticket" : "Event – Step 3 (Ticket)"}
      </h2>
      ...
      <div className="flex flex-col gap-6 md:grid md:grid-cols-12">
        ...
        {/* FORM */}
        <div className="md:col-span-8 border rounded-lg p-4 space-y-4 bg-white">
          <div>

  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        stat: {
          events: "hsl(var(--stat-events))",
          "events-bg": "hsl(var(--stat-events-bg))",
          admins: "hsl(var(--stat-admins))",
          "admins-bg": "hsl(var(--stat-admins-bg))",
          orders: "hsl(var(--stat-orders))",
          "orders-bg": "hsl(var(--stat-orders-bg))",
          revenue: "hsl(var(--stat-revenue))",
          "revenue-bg": "hsl(var(--stat-revenue-bg))",
        },
        status: {
